...
class GameView {
  ...
  cvcSlimes() {
    this.slime1 = this.game.addRAISlime(1);
    this.slime2 - this.game.addRAISlime(3);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__puck__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__goals__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__game_view__ = __webpack_require__(33);
...
class Game {
  ...
  add(object){
    ...
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_2__puck__["a" /* default */]) {
  ...
  addPuck() {
    const puck = new __WEBPACK_IMPORTED_MODULE_2__puck__["a" /* default */]({
  ...
  addGoals() {
    const goal1 = new __WEBPACK_IMPORTED_MODULE_3__goals__["a" /* default */]({
      posX: this.field.minimumSize,
      field: this.field
    });
    this.goals.push(goal1);
    const goal2 = new __WEBPACK_IMPORTED_MODULE_3__goals__["a" /* default */]({
  ...
  resetGame() {
    ...
    new __WEBPACK_IMPORTED_MODULE_4__game_view__["a" /* default */](game, this.ctx).menu();
  }

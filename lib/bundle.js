...
var chainable_1 = __webpack_require__(15);
...
Object.defineProperty(exports, "__esModule", { value: true });
var on_next_frame_1 = __webpack_require__(36);
var create_render_step_1 = __webpack_require__(37);
...
Object.defineProperty(exports, "__esModule", { value: true });
var multi_1 = __webpack_require__(18);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_popmotion__ = __webpack_require__(14);
...
class MovingObject {
  ...
  isCollidedWith(otherObject) {
    const centerDist = __WEBPACK_IMPORTED_MODULE_0_popmotion__["calc"].distance(this.pos, otherObject.pos)
...
var stylefire_1 = __webpack_require__(49);
exports.styler = stylefire_1.default;
var css_1 = __webpack_require__(27);
exports.css = css_1.default;
var svg_1 = __webpack_require__(32);
...
var transformers_1 = __webpack_require__(4);
var tween_1 = __webpack_require__(20);
var scrubber_1 = __webpack_require__(21);
...
Object.defineProperty(exports, "__esModule", { value: true });
var styler_1 = __webpack_require__(28);
var prefixer_1 = __webpack_require__(29);
var render_1 = __webpack_require__(30);
...
var styler_1 = __webpack_require__(28);
var utils_1 = __webpack_require__(12);
var build_1 = __webpack_require__(50);
var value_types_1 = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__game__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_view__ = __webpack_require__(54);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__slime__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__puck__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__goals__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__game_view__ = __webpack_require__(54);
...
class Game {
  ...
  add(object){
    ...
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_1__puck__["a" /* default */]) {
  ...
  addPuck() {
    const puck = new __WEBPACK_IMPORTED_MODULE_1__puck__["a" /* default */]({
  ...
  addGoals() {
    const goal1 = new __WEBPACK_IMPORTED_MODULE_2__goals__["a" /* default */]({
      posX: this.field.minimumSize,
      field: this.field
    });
    this.goals.push(goal1);
    const goal2 = new __WEBPACK_IMPORTED_MODULE_2__goals__["a" /* default */]({
  ...
  displayEndScreen(){
    ...
    const restartButton = document.createTextNode("Restart");
    restart.appendChild(restartButton);
    const restartEnter = document.createElement('H3');
    const restartText = document.createTextNode("Or Press Enter to Restart");
    restartEnter.appendChild(restartText);
    result.appendChild(head);
    result.appendChild(restart);
    result.appendChild(restartEnter);
    restart.addEventListener('click', () => {
      new __WEBPACK_IMPORTED_MODULE_3__game_view__["a" /* default */](new Game(this.ctx), this.ctx).start();
    })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__moving_object__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_popmotion__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_popmotion___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_popmotion__);
...
class Slime extends __WEBPACK_IMPORTED_MODULE_0__moving_object__["a" /* default */] {
  ...
  isCollidedWith(otherObject) {
    const centerDist = __WEBPACK_IMPORTED_MODULE_1_popmotion__["calc"].distance(this.pos, otherObject.pos)
    return centerDist < (this.radius + otherObject.radius);
  }
